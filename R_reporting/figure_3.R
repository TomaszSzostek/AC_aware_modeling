...
ggsave("R_reporting/figures/Figure_3.pdf", final_fig, width = 14, height = 11, dpi = 500, device = cairo_pdf)
ggsave("R_reporting/figures/Figure_3.png", final_fig, width = 14, height = 11, dpi = 500, bg = "white")
