...
cat("\n", strrep("=", 80), "\n")
cat("Figure 2: Predictive Model Performance\n")
cat(strrep("=", 80), "\n\n")
...
ggsave("R_reporting/figures/Figure_2.pdf", final_fig, width = 9, height = 4.5, dpi = 500, device = cairo_pdf)
ggsave("R_reporting/figures/Figure_2.png", final_fig, width = 9, height = 4.5, dpi = 500, bg = "white")
