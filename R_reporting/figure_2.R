...
ggsave("R_reporting/figures/Figure_2.pdf", final_fig, width = 14, height = 11, dpi = 500, device = cairo_pdf)
ggsave("R_reporting/figures/Figure_2.png", final_fig, width = 14, height = 11, dpi = 500, bg = "white")

cat("\nFigure 2 saved (500 DPI)\n\n")
